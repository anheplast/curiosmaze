...
/* Estilos para el modal de estudiante */
.modal-title-icon {
...
.evaluation-score.excellent {
  background-color: rgba(156, 190, 182, 0.15);
...
/* Nuevo: Botón de detalles de evaluación */
.evaluation-actions {
  display: flex;
...
@media (prefers-color-scheme: light) {
  .student-management-wrapper .input::placeholder {
    color: #6b7280;
  }
}
</style>