<!-- components/admin/ActiveUsers.vue -->
<template>
            ...
            <tr v-for="user in filteredUsers" :key="user.id">
              ...
              <td class="actions-cell">
                <div class="action-buttons">
                  ...
                  <button class="button is-small password-btn" title="Resetear contraseña" @click="$emit('reset-password', user)">
                    <span>🔑</span>
                  </button>
                  <button class="button is-small deactivate-btn" title="Desactivar" @click="$emit('deactivate-user', user)">
                    <span>🚫</span>
                  </button>
                </div>
              </td>
