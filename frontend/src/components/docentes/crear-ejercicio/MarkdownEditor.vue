...
/* Clase específica para el textarea de este componente */
.markdown-textarea {
    min-height: 300px;
    height: 100%;
    overflow-y: auto;
...
/* Estilos mejorados para el modal de imágenes */
.modal-card-foot {
    display: flex;
    justify-content: flex-end;
    gap: 1rem; /* Aumentar espacio entre botones */
    padding: 1rem 1.5rem; /* Padding más cómodo */
}

.modal-card-foot .button {
    margin: 0; /* Quitar margen que pudiera ser heredado */
...
.markdown-preview p {
    margin-bottom: 1rem;
    color: var(--color-text, #1a1a1a); /* Valor por defecto para tema claro */
}
...
.markdown-preview code {
    background-color: #f0f0f0; /* Gris claro para tema claro */
